...
#SBATCH --output=m31-Individual-plots-on-RM-vs-rad-proj-%j-$(date +%Y%m%d-%H%M%S).log
#SBATCH --error=m31-Individual-plots-on-RM-vs-rad-proj-%j-$(date +%Y%m%d-%H%M%S)-error.log
#SBATCH --ntasks=1
